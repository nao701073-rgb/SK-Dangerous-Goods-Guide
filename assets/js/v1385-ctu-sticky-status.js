(()=>{
  ...
  function evaluate(){
    ...
    if(combined&&(!$('quickCombinationConfirmed')?.checked||!hasAccepted('quickCombinationConfirmed')))review.push(item('併用の荷重分担・作用方向','quickCombinationConfirmed','securing','review',5));
  ...
  function confirmAllCurrent(){
    ...
    if($('quickUseTensile')?.checked&&$('quickUseSupport')?.checked){const c=$('quickCombinationConfirmed');if(c){c.checked=true;accept('quickCombinationConfirmed')}}
  ...
  window.__SK_ASSET_BUILD__=Object.assign(window.__SK_ASSET_BUILD__||{}, {'assets/js/v1385-ctu-sticky-status.js':'v1.3.85'});
})();
