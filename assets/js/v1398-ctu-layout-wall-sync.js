...
function bindLayout(){
  ...
  requestAnimationFrame(()=>requestAnimationFrame(()=>{delete document.body.dataset.ctuLayoutPrepaint;}));
}
...
window.__SK_ASSET_BUILD__=Object.assign(window.__SK_ASSET_BUILD__||{}, {'assets/js/v1398-ctu-layout-wall-sync.js':'v1.3.114-first-paint-stable'});
})();
