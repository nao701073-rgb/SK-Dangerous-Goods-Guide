...
function sync(){
 ...
 const confirm=$('quickCombinationConfirm');if(confirm)confirm.hidden=!(u.tensile&&u.support);
 if(!(u.tensile&&u.support)&&$('quickCombinationConfirmed'))$('quickCombinationConfirmed').checked=false;
...
window.__SK_ASSET_BUILD__=Object.assign(window.__SK_ASSET_BUILD__||{}, {'assets/js/v1385-ctu-dual-use-toggle.js':'v1.3.85'});
})();
