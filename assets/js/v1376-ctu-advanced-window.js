(()=>{
  ...
  function applyToMain(control){
    ...
    // Popup-originated DOM events are not trusted events in the main window, so
    // explicitly notify the workflow that a calculation input changed.
  ...
  window.__SK_ASSET_BUILD__=Object.assign(window.__SK_ASSET_BUILD__||{}, {'assets/js/v1376-ctu-advanced-window.js':'v1.3.76'});
})();
