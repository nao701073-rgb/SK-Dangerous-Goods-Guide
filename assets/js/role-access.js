(() => {
  ...
  const PERMISSIONS = {
    ...
    "guest": { applicationsRead:false, applicationsWrite:false, applicationNotesRead:false, applicationNotesWrite:false, applicationDocumentsRead:false, applicationDocumentsWrite:false, photosRead:false, photosWrite:false, dangerousGoodsSearch:true, regulationsRead:true, referencesRead:true, userSettings:true },
...
window.__SK_ASSET_BUILD__ = Object.assign(window.__SK_ASSET_BUILD__ || {}, { "assets/js/role-access.js": "part503" });
