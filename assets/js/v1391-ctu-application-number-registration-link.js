(()=>{
  ...
  window.addEventListener('sk:ctu-application-number-prefilled',event=>linkImportedIdentity(event.detail||{}));
  ...
  window.SKCTUApplicationNumberLinkV1391={getState:()=>JSON.parse(JSON.stringify(state)),normalizedIdentity,findExisting,prepareRegistration,linkImportedIdentity,clearLink};
  window.__SK_ASSET_BUILD__=Object.assign(window.__SK_ASSET_BUILD__||{}, {'assets/js/v1391-ctu-application-number-registration-link.js':'v1.3.91'});
})();
