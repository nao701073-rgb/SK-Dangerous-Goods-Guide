...
ok(version.version==='v1.3.100','VERSION is v1.3.100');
ok(version.base==='v1.3.98-complete','base is v1.3.98 complete');
...
ok(manifest.includes('version: "v1.3.100"')&&manifest.includes("v13100:{version:'v1.3.100'"),'build manifest is v1.3.100 and contains v13100 extension');
...
ok(html.includes('v13100-ctu-complete-visual-system.css?v=13100'),'v13100 complete visual CSS is loaded last');
