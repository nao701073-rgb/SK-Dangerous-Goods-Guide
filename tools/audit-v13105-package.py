...
OUT=ROOT/'docs'/'verification'/'v1.3.105';OUT.mkdir(parents=True,exist_ok=True)
...
(OUT/'v13105_full_audit.json').write_text(json.dumps(report,ensure_ascii=False,indent=2),encoding='utf-8')
...
(OUT/'v13105_full_audit.log').write_text('\n'.join(log)+'\n',encoding='utf-8')
print('\n'.join(log))
