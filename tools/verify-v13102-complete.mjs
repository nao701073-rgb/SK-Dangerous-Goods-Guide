...
ok(version.version==='v1.3.102','VERSION is v1.3.102');
ok(version.base==='v1.3.101','base is v1.3.101 complete');
...
ok(manifest.includes('version: "v1.3.102"')&&manifest.includes("v13102:{version:'v1.3.102'"),'build manifest is v1.3.102 and contains v13102 extension');
