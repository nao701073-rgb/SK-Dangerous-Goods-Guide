...
ok(version.version==='v1.3.103','VERSION is v1.3.103');
ok(version.base==='v1.3.102','base is v1.3.102 complete');
...
ok(manifest.includes('version: "v1.3.103"')&&manifest.includes("v13103:{version:'v1.3.103'"),'build manifest is v1.3.103 and contains v13103 extension');
