...
check('申請番号管理の現行版識別',appsHtml.includes('content="part531"'));
...
check('固縛力画面の現行版識別',ctuHtml.includes('content="part531"'));
...
check('VERSION part531',version.version==='part531'&&version.part===531);
...
const report={generatedAt:new Date().toISOString(),release:'part531',status:failed.length?'failed':'passed',total:checks.length,passed:checks.length-failed.length,failed:failed.length,checks};
const out=path.join(root,'docs','part531_Part529共通案件情報回帰検証レポート.json');
