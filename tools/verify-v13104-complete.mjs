...
ok(version.version==='v1.3.104','VERSION is v1.3.104');
ok(version.base==='v1.3.103','base is v1.3.103 complete');
...
ok(manifest.includes('version: "v1.3.104"')&&manifest.includes("v13104:{version:'v1.3.104'"),'build manifest is v1.3.104 and contains v13104 extension');
